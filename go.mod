module github.com/RedHatInsights/frontend-development-proxy

go 1.25.6

require (
	github.com/RedHatInsights/frontend-development-proxy/feo_interceptor v0.0.0-00010101000000-000000000000
	github.com/RedHatInsights/frontend-development-proxy/rh_identity_transform v0.0.0-00010101000000-000000000000
...
replace (
	github.com/RedHatInsights/frontend-development-proxy/feo_interceptor => ./feo_interceptor
	github.com/RedHatInsights/frontend-development-proxy/rh_identity_transform => ./rh_identity_transform
)
